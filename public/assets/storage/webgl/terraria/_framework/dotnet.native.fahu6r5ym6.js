...
var INITIAL_MEMORY = Module["INITIAL_MEMORY"] || 64421888;
...
var ASM_CONSTS = {
 ...
 12561870: () => Module["SDL3"].audioContext.sampleRate,
 12561921: ($0, $1, $2, $3) => {
  var SDL3 = Module["SDL3"];
 ...
 12567475: () => (navigator.mediaDevices === undefined) ? 0 : 1,
 12567534: ($0, $1, $2, $3, $4, $5, $6) => {
  const device = $0;
  const w = $1;
  const h = $2;
 ...
 12578729: () => window.innerWidth,
 12578759: () => window.innerHeight,
 12578790: $0 => {
